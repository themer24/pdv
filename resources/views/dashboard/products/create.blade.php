                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="{{$locale}}[description]" class="form-control ckeditor" id="">{{old($locale.'.description')}}</textarea>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <img src="{{asset('uploads/product_images/default.png')}}" style="width: 100px" class="img_thumbnail image-preview" alt="">
                  </div>
                  <div class="form-group">
