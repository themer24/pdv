           ...
           <form action="{{route('dashboard.products.update',$product->id)}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <input type="text" name="{{$locale}}[name]" class="form-control" id="" value="{{$product->name}}">

                 </div>
                 <div class="form-group">
                   <label>@lang('site.'.$locale.'.description')</label>
                   <textarea name="{{$locale}}[description]" class="form-control ckeditor" id="">{{$product->description}}</textarea>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                 <img src="{{$product->image_path}}" style="width: 100px" class="img_thumbnail image-preview" alt="">
                 </div>
                 <div class="form-group">
