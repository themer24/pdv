    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <form action="{{route('dashboard.users.index')}}" method="GET">
                  <div class="row">
                      <div class="col-md-4">
                      <input type="text" name="search" class="form-control" placeholder="@lang('site.search')" id="" value="{{request()->search}}">
                      </div>
                      <div class="col-md-4">
                    ...
                    <tbody>
                        @foreach ($users as $index=>$user)
                            <tr>
                                ...
                                <td>
                                <img src="{{$user->image_path}}" style="width: 100px" class="image_thumbnail" alt="">
                                </td>
